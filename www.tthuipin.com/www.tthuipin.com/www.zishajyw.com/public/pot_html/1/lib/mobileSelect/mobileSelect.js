...
(function() {
	...
	MobileSelect.prototype = {
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText){
			var _this = this;
			var cancelText = cancelBtnText ? cancelBtnText : '取消 Cancel';
			var ensureText = ensureBtnText ? ensureBtnText : '确认 Confirm';
		...
		fixRowStyle: function(){
			var _this = this;
			_this.wheel[0].style.width = '15%';
			_this.wheel[1].style.width = '15%';
			_this.wheel[2].style.width = '70%';
