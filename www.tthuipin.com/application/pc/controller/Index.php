...
//        dump($this->shop_car);
    ...
    public function index(){
        ...
        if(preg_match('/chaofengguwu\.shop|happyguwu\.shop|youmeishop\.shop/',$server_name)){
            ...
            return $this->fetch('homePage/home_page6');
        }else if(preg_match('/xinpinshishang\.shop|xinxingou\.shop|promiseyou\.shop/',$server_name)){
            return $this->fetch('homePage/home_page2');
        }else if(preg_match('/tiantianlegou\.shop|newgou\.shop|chaopinhui\.shop/',$server_name)){
            return $this->fetch('homePage/home2');
        }else if(preg_match('/xiaoLongkaka\.shop|aishanggouwu\.shop|anningxiaodian\.shop/',$server_name)){
            return $this->fetch('homePage/home3');
        }else if(preg_match('/chaodashop\.shop|chaodastore\.shop|chaodagowu\.shop/',$server_name)){
            return $this->fetch('homePage/home_page4');
        }else if(preg_match('/fashiongou\.shop|happygouwu\.shop|tiantianyigou\.shop/',$server_name)){
            return $this->fetch('homePage/home_page3');
        }
